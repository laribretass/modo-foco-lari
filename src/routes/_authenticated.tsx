...
import { Home, BookOpen, TrendingUp, FileCheck, Calendar, PenLine, Heart, Settings, LogOut, Sparkles, Menu } from "lucide-react";
...
function AuthLayout() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 pb-24 max-w-6xl mx-auto w-full">
        <Outlet />
      </main>

      {/* Bottom tab bar */}
      <nav className="fixed bottom-0 left-0 right-0 z-40 border-t bg-background/95 backdrop-blur-md safe-bottom">
